...
For now, the rewrite is available in [this repo](https://github.com/Phate6660/rsfetch).<br>
When I feel like enough has been done in the rewrite, I will begin to overwrite this repo with the rewrite.**
